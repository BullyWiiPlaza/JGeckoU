...
import wiiudev.gecko.client.gui.watch_list.WatchListElement;
...
public abstract class AbstractXMLStorage
{
	...
	protected String store(List<WatchListElement> watchListElements) throws Exception
	{
	...
	protected List<WatchListElement> restore() throws Exception
	{
